...
Metro newTest = Metro(1);  
 
#include <AccelStepper.h> // Define a stepper and the pins it will use
#define NBMOTEURS 6
//#define SerialUSB Serial1 // to change instance SerialUSB as Serial1
...
// 6400 Arduino Due 
// const uint8_t PINDIRECTION[NBMOTEURS] = { 52, 48, 44, 40, 36, 32, 28, 24, 21, 17 };//{ 10, 6, 2, 22, 26};
// const uint8_t PINSPEED[NBMOTEURS]=      { 53, 49, 45, 41, 37, 33, 29, 25, 20, 16 }; //{ 11, 7, 3, 23, 27};
